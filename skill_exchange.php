...
<!-- navigation -->
    ...
    <div class="ui tablet computer only padded grid">
      <div class="ui borderless fluid small inverted menu">
        <div class="ui container">
          ...
          <a class="active item" href="skill_exchange.php">Ekill Exchange</a>
  ...
  <i>Find your Desire Skill</i>
</h2>
<h2> <br> </h2>

      <div class="ui text container">
          <form class="ui form" method=POST action=skill_exchange_Result.php>
...
<b>Get Creative With Skillshare</b>
 <br>
...
Connect with a global community of curious creatives.With inspiring classes on soft skills, business essentials, well‑being and more, your whole team will have deep knowledge and expertise at their fingertips.</p></div>
    
             
           </div>
    <br><br>
    <div>
<p><label>Select skill</label>
      <div class="ui selection dropdown">
        <input type="hidden"name="skill">
        <i class="dropdown icon">choose your desire skill</i>
